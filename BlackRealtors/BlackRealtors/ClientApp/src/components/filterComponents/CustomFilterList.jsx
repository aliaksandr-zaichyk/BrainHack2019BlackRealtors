...
import { addCustomPoint, addCustomPointAction, deleteCustomPoint } from '../../actions/actions';
...
class CustomFilterList extends Component {
  ...
  addFilter = () => {
    ...
    this.props
      .addPoint(`${address}, Беларусь, Гродно`);
      ...
      <Card>
        ...
        </Alert>
        {
          this.state.items.map((item, index) =>
            <CustomFilterItem key={index} item={item} deleteItem={this.deleteFilter} />
          )
        }
        < Row >
          <Col xs='9'>
...
export default connect(null, mapDispatchToProps)(CustomFilterList);